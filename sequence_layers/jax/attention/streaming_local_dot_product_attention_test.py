...
from sequence_layers.jax.attention import streaming_local_dot_product_attention
...
class StreamingLocalDotProductAttentionTest(test_utils.SequenceLayerTest):
  ...
  def test_basic(
    ...
    l = streaming_local_dot_product_attention.StreamingLocalDotProductAttention.Config(
        source_name,
        num_heads=num_heads,
